            ...
            child: Form(
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'Only approved admin accounts should proceed. Access will be checked after OTP verification.',
                            style: TextStyle(
                              fontSize: 12.5,
                              height: 1.45,
                  ...
                  Text(
                    'You will verify your identity using the code sent to your email.',
                    textAlign: TextAlign.center,
                    style: TextStyle(
                      fontSize: 12.5,
