...
Future<void> showScanReportDetailsDialog({
                ...
                child: Column(
                  children: [
                    ...
                    _SectionCard(
                      ...
                      child: Column(
                        children: [
                          _detailRow('Total Samples', safeText(item['totalsample'])),
                          _detailRow(
                            'Cumulative Eggs',
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Scan report by ${getFarmerName(item)}',
                  style: TextStyle(
                    fontSize: 14,
                ...
                Wrap(
                  ...
                  children: [
                    _Badge(
                      label: safeText(item['finaldecision']),
                      backgroundColor: const Color(0xFFEEF2FF),
                      textColor: const Color(0xFF4338CA),
                    ),
                    _Badge(
                      label: '${safeText(item['cumulativeeggs'])} eggs',
